...
public class ListAdapter3 extends BaseAdapter {
    ...
    public View getView(int position, View child, ViewGroup parent) {
        ...
        if (child == null) {
            ...
            child = layoutInflater.inflate(R.layout.items3, null);
            ...
            holder.SlotTextView = (TextView) child.findViewById(R.id.textViewSLOT);
        ...
        holder.SlotTextView.setText(Slot.get(position));
