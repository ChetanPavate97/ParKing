...
public class SQLiteHelper2 extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME="book1";
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        String CREATE_TABLE="CREATE TABLE IF NOT EXISTS "+TABLE_NAME+" ("+Table_Column_ID+" INTEGER PRIMARY KEY, "+Table_Column_1_Date+" VARCHAR, "+Table_Column_2_Time+" VARCHAR, "+Table_Column_3_Duration+" VARCHAR,"+Table_Column_4_Uname+" VARCHAR, "+Table_Column_5_Type+" VARCHAR)";
